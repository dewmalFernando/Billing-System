...
<div class="container">
  ...
  <div class="form-group">
      ...
      <input type="numbers" class="form-control" id="priceCode" name="priceCode" required>
    </div>
    <div class="form-group">
      <label for="price">Price</label>
      <input type="numbers" class="form-control" id="price" name="price" required>
    </div>
    <button type="submit" id="addButton" class="btn btn-dark">Add</button>
  </form>
</div>
</section>
...
<?php 
  if(isset($_POST['addButton'])){
    ...
    $insertQuery = "insert into price(Price, Price_Code) values('$price' ,'$priceCode')";
    $resultInsert = mysqli_query($connection, $insertQuery);
    if(!$resultInsert){
      echo "Unsuccessful";
    } else {
      $message = "A new price added successfully.";
